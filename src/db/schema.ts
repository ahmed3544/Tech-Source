...
export const notifications = pgTable('notifications', { id: text('id').primaryKey(), recipientId: text('recipient_id').notNull(), type: text('type').notNull(), title: text('title').notNull(), message: text('message').notNull(), relatedEmployeeId: text('related_employee_id'), relatedOvertimeId: text('related_overtime_id'), relatedShiftSwapId: text('related_shift_swap_id'), relatedEmployeeId: text('related_employee_id'), isRead: boolean('is_read').default(false), createdAt: text('created_at').notNull(), updatedAt: text('updated_at').notNull(), });
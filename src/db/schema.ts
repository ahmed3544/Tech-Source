...
export const leaveRequests = pgTable('leave_requests', {
  id: text('id').primaryKey(), employeeId: text('employee_id').notNull(), type: text('type'), startDate: text('start_date'), endDate: text('end_date'), reason: text('reason'), status: text('status'), createdAt: text('created_at'), updatedAt: text('updated_at'), hours: integer('hours'), permissionSlot: text('permission_slot'), attachmentUrl: text('attachment_url'), attachmentName: text('attachment_name'), reviewedBy: text('reviewed_by'), reviewNotes: text('review_notes'),
});

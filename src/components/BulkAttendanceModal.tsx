...
export const BulkAttendanceModal: React.FC<BulkAttendanceModalProps> = ({
  ...
  const renderStatusBadge = (status: AttendanceStatus) => {
    switch (status) {
      ...
      default:
        return <span className="px-2 py-0.5 rounded-md bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 text-[11px] font-bold border border-slate-200 dark:border-slate-700">{status}</span>;
    }
  };
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-700 shadow-2xl max-w-3xl w-full overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="bg-[#0d2240] text-white p-5 flex items-center justify-between border-b border-blue-900 shrink-0">
          ...
          <button
            ...
            className="p-2 text-slate-300 hover:text-white hover:bg-white dark:bg-slate-900/10 rounded-xl transition"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-800/50 focus:bg-white dark:bg-slate-900 focus:ring-2 focus:ring-blue-500 text-sm font-semibold text-slate-800 dark:text-slate-200"
                >
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      className="w-32 px-3.5 py-2.5 rounded-xl border border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-800/50 focus:bg-white dark:bg-slate-900 focus:ring-2 focus:ring-blue-500 text-sm font-bold text-slate-800 dark:text-slate-200 text-center"
                    />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-800/50 focus:bg-white dark:bg-slate-900 focus:ring-2 focus:ring-blue-500 text-sm font-bold text-slate-800 dark:text-slate-200"
                  />
                </div>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                ...
                <div className="p-3 bg-slate-100 dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 text-center">
                  <p className="text-[11px] text-slate-600 dark:text-slate-400 font-bold">{lang === 'ar' ? 'سيتم تخطيها' : 'To Skip'}</p>
                  <p className="text-xl font-black text-slate-800 dark:text-slate-200">{stats.skipCount}</p>
                </div>
              </div>
              ...
              <div className="border border-slate-200 dark:border-slate-700 rounded-2xl overflow-hidden max-h-72 overflow-y-auto">
                <table className="w-full text-right text-xs">
                  ...
                  <tbody className="divide-y divide-slate-100 font-medium text-slate-800 dark:text-slate-200">
                    {previewItems.slice(0, 100).map((item, idx) => (
                      <tr key={idx} className={item.actionWillTake === 'skip' ? 'bg-slate-50 dark:bg-slate-800/50/60 opacity-60' : 'hover:bg-slate-50 dark:bg-slate-800/50'}>
                        ...
                        <td className="p-2.5">
                          ...
                          {item.actionWillTake === 'skip' && (
                            <span className="inline-flex items-center gap-1 text-[11px] font-bold text-slate-500 bg-slate-100 dark:bg-slate-800 px-2 py-0.5 rounded-md border border-slate-200 dark:border-slate-700">
        ...
        {/* Footer Actions */}
        <div className="bg-slate-50 dark:bg-slate-800/50 p-4 border-t border-slate-200 dark:border-slate-700 flex items-center justify-between shrink-0">
          {step === 'configure' ? (
            <>
              <button
                type="button"
                onClick={onClose}
                className="px-4 py-2.5 rounded-xl border border-slate-300 dark:border-slate-600 hover:bg-slate-200 text-slate-700 dark:text-slate-300 font-bold text-xs transition"
              >

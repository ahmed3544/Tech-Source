...
// Build patches must be idempotent: another prebuild patch may already have
// changed this section. In that case, do not fail the entire Vercel build.
if (!code.includes(marker)) {
  console.warn('[patch_client_authoritative_sync] marker not found; skipping (source may already be patched).');
  process.exit(0);
}
